    ...
    return (
        <section id="results" className="section-spacing" style={{ backgroundColor: '#fafafa' }}>
            <div className="container">
                <h2 style={{ fontSize: '2.5rem', marginBottom: '3rem', textAlign: 'center' }}>What Results Look Like</h2>
                ...
                <p style={{ textAlign: 'center', fontSize: '1.25rem', fontWeight: 600 }}>SEO becomes a growth channel, not a cost center.</p>
            </div>
        </section>
    );
};
